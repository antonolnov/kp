...
1. ПУСТОТА ВНИЗУ: Есть ли пустое пространство внизу страницы (более 15%)? Если да — нужен маскот!
...
4. ВИЗУАЛЬНЫЙ БАЛАНС: Нет "каши" — элементы не слипаются, есть воздух между блоками
5. ЧИТАЕМОСТЬ: Текст достаточного размера, контраст нормальный
6. МАСКОТ: Если есть — размещён посередине пустого пространства, не прилеплен к тексту

Ответь в формате JSON:
{
    "is_ok": true/false,
    "has_empty_space": true/false,

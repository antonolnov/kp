...
ВАЖНО:
1. Пиши КОМПАКТНО — каждый пункт максимум 15-20 слов, одно предложение
2. why_recruiters и why_managers — КОРОТКИЕ пункты по 10-15 слов максимум
3. Связывай решения с болями клиента
4. Используй конкретику из разговора — названия, цифры
5. Не выдумывай то, чего не было в разговоре
6. Пиши живым языком, без воды
...
{{
    ...
    "why_recruiters": [
        "Короткая выгода для рекрутеров — максимум 10-15 слов",
        "Ещё короткая выгода"
    ],
    
    "why_managers": [
        "Короткая выгода для руководителей — максимум 10-15 слов",
        "Ещё короткая выгода"
    ],

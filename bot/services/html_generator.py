...
2. Маскоты ТОЛЬКО внизу страницы для заполнения пустоты! ЗАПРЕЩЕНО вставлять котов между разделами в середине страницы
3. Пункты списков — КОРОТКИЕ, максимум 15-20 слов
4. Раздел 5 — по 2-3 коротких пункта в каждой колонке
5. В конце — призыв к действию
